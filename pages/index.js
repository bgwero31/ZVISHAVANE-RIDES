...
<style jsx>{  .nextRideBackground {   position: fixed;   width: 100%;   height: 100%;   background: radial-gradient(circle at center, #101820 0%, #0c0c0c 100%);   overflow: hidden;   z-index: -1;   }   .movingLines {   position: absolute;   width: 100%;   height: 100%;   background-image: linear-gradient(   to top,   transparent 70%,   rgba(0, 242, 254, 0.4) 85%,   transparent 100%   );   background-size: 100% 40px;   animation: moveLines 1.5s linear infinite;   opacity: 0.6;   }   .grid {   position: absolute;   width: 200%;   height: 200%;   top: -50%;   left: -50%;   background: repeating-linear-gradient(   to right,   rgba(0, 242, 254, 0.1) 0,   rgba(0, 242, 254, 0.1) 1px,   transparent 1px,   transparent 40px   ),   repeating-linear-gradient(   to bottom,   rgba(0, 242, 254, 0.1) 0,   rgba(0, 242, 254, 0.1) 1px,   transparent 1px,   transparent 40px   );   animation: rotateGrid 100s linear infinite;   opacity: 0.2;   }   @keyframes moveLines {   0% {   background-position: 0 0;   }   100% {   background-position: 0 100%;   }   }   @keyframes rotateGrid {   0% {   transform: rotate(0deg);   }   100% {   transform: rotate(360deg);   }   }  }</style>
</>
);
